...
router.get("/warnings", restrictTo("procurement_officer", "finance_officer", "admin"), getBudgetWarnings);
...
router
  .route("/")
  .get(restrictTo("procurement_officer", "finance_officer", "department_manager", "admin"), validateListBudgetsQuery, getBudgets)
  .post(restrictTo("finance_officer", "admin"), validateCreateBudget, createBudget);
