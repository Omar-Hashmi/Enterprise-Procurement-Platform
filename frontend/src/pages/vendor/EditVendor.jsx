...
export const EditVendor = () => {
  ...
  const { getVendorById, updateVendor, isLoading, error: apiError } = useVendor();
  ...
  useEffect(() => {
    const fetchVendorData = async () => {
      try {
        ...
        // Error handling managed by hook / API response
      } finally {
        setIsFetching(false);
      }
    };
            ...
            <Grid container spacing={2.5} sx={{ mb: 4 }}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  ...
                  <MenuItem value="BLACK_LISTED">Blacklisted</MenuItem>
                </TextField>
              </Grid>
