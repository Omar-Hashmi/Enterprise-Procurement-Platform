  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 }, maxWidth: 800, margin: '0 auto' }}>
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 1 }}>
        ...
        <Typography color="text.primary">Create Delivery</Typography>
      </Breadcrumbs>

      <Typography variant="h5" fontWeight={700} sx={{ mb: 2 }}>Create Delivery</Typography>
      <Card variant="outlined"><CardContent><DeliveryForm /></CardContent></Card>
    </Box>
  );
}
